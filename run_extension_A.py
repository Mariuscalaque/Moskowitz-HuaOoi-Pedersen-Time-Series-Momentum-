"""Extension A — Le « smile » de TSMOM comme DÉPENDANCE DE QUEUE (copules).
...
_TSMOM_PATH = Path("outputs/tables/diversified_tsmom_series.csv")
...
print("\n" + "=" * 64)
print("VERDICT — Le straddle : regression (Table 3C) vs copules (Ext. A)")
print("=" * 64)
...
if not gauss_rejected:
    ...
    print("     l'Extension C montre qu'elle est NETTE pour les actions (Delta AIC>>0).")
